...
% 2. Rules to determine if a given patient has any symptoms of a specific severity, or any given risk factor.
...
% 5. Rule to aggregate scores for patient severities and risk factors
score_patient(Patient, TotalScore) :-
    ...
    TotalScore is (0.6 * SymptomScore) + (0.4 * RiskScore). % 60/40 symptom/risk relative contribution
...
Score1 = 0.39360000000000006,
Proba1 = 0.5482493912654847,
Class1 = Class3, Class3 = Class4, Class4 = Class6, Class6 = Class7, Class7 = 1,
Score2 = 0.112,
Proba2 = 0.47801418634752707,
Class2 = Class5, Class5 = Class8, Class8 = 0,
Score3 = 0.528,
Proba3 = 0.5812726666092255,
Score4 = 1.2511999999999999,
Proba4 = 0.7410052655322968,
Score5 = 0.3148,
Proba5 = 0.0,
Score6 = 0.207,
